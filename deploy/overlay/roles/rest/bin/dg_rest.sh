#!/bin/sh
SERVICE_NAME="DG REST Service"
CLASSPATH="$DG_HOME/lib/rest/jetty-runner-9.3.5.v20151012.jar:$DG_HOME/lib/rest/ares-apps-0.0.1-SNAPSHOT.jar:$DG_HOME/lib/rest/guava-14.0.jar:$DG_HOME/lib/rest/jsr311-api-1.1.1.jar:$DG_HOME/lib/rest/*"
PID_PATH_NAME=/tmp/rest-pid
LOG_FILE=$DG_HOME/log/rest/rest_startup.log
