 ...
 */
public class GenericHDFSEventProcessor implements  HDFSFileProcessor, Dependent {
	...
	public void processFile(FileInputMetadata metadata, InputStream in) throws Exception {
		...
		System.out.println(" GenericHDFSEventProcessor : processing file " + metadata.getFilename());
		...
		//System.out.println(" GenericHDFSEventProcessor : raw JSON: " + rawJsons.toString());
		...
		/*		System.out.println(" GenericHDFSEventProcessor : sending to JDBC");
				...
				System.out.println(" GenericHDFSEventProcessor : sent to JDBC");
